package com.xiaocoder.android_recordvoice_demo;
...
import com.xiaocoder.android_recordbutton.XCRecordVoiceButton;
...
public class RecordVoiceActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recoder_voice);
        initWidgets();
        setListeners();
    }
    ...
    public void initWidgets() {
        ...
        File saveDir = XCIOAndroid.createDirInAndroid(this, "app_recordvoice");
