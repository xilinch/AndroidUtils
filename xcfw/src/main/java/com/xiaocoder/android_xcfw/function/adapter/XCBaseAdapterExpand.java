 ...
 * @description
 */
public abstract class XCBaseAdapterExpand<E, T> extends BaseExpandableListAdapter {
    /**
     * 子item
     */
    ...
    public XCBaseAdapterExpand(Context context, List<List<T>> listChild, List<E> listParaent) {
