package com.xiaocoder.android_xcfw.function.fragment;
...
import com.xiaocoder.android_xcfw.util.UtilOom;
 ...
 */
public class XCCameraPhotoFragment extends XCFragment implements View.OnClickListener {
...
//                    bitmap = Bitmap.createScaledBitmap(bitmap, 700, 700, true);
    ...
    public String save_photo_dir = ""; // XCConstant.CHAT_PHOTO_FILE
