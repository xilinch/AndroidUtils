package com.xiaocoder.android_zxcode.camare;
...
public final class CameraManager {
	...
	private static final int MAX_FRAME_WIDTH = 670; // 这里可以修改扫描框的宽
	// private static final int MAX_FRAME_HEIGHT = 360;
	private static final int MAX_FRAME_HEIGHT = 700; // 这里可以修改扫描框的高
