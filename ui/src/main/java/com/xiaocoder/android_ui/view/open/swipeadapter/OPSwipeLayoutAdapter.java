package com.xiaocoder.android_ui.view.open.swipeadapter;
 ...
 */
public abstract class OPSwipeLayoutAdapter<T> extends ArrayAdapter {
     ...
     * @param objects
     */
    public OPSwipeLayoutAdapter(Context context, int contentViewResourceId, int actionViewResourceId, T[] objects) {
     ...
     * @param objects
     */
    public OPSwipeLayoutAdapter(Context context, int contentViewResourceId, int actionViewResourceId, List<T> objects) {
        super(context, R.layout.xc_l_view_swipeadapter, objects);
        _contentViewResourceId = contentViewResourceId;
        _actionViewResourceId = actionViewResourceId;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final OPSwipeViewHolder viewHolder;
        if (convertView == null) {
            //获取Item
            ...
            viewHolder = new OPSwipeViewHolder();
            //获取item组件
            ...
            viewHolder = (OPSwipeViewHolder) convertView.getTag();
        ...
        //设置滑动事件监听
        convertView.setOnTouchListener(new OPSwipeOnTouchListener());
        return convertView;
    }
}
