package com.xiaocoder.android_ui.view.xl.waveview;
...
class Wave extends View {
    private final int WAVE_HEIGHT_LARGE = 22;
    ...
    private final float WAVE_HZ_SLOW = 0.01f;
    ...
    // wave animation
    private float mAboveOffset = 1.3f;
