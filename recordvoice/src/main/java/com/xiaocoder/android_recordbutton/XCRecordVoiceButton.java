package com.xiaocoder.android_recordbutton;
...
public class XCRecordVoiceButton extends Button {
    ...
    public File getSaveDir() {
        if (save_dir == null) {
            save_dir = XCIOAndroid.createDirInAndroid(getContext(), "appTempVoiceDir123");
        }
        return save_dir;
    }
    ...
    public void log(String msg) {
        XCLog.i(this.getClass().getSimpleName(), msg);
    }
