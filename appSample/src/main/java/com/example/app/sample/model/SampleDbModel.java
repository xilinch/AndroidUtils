...
@Querys({
        ...
        @Query(methodName = "query12", where = "null"),
        @Query(methodName = "query13", where = "null", orderBy = "null"),
        @Query(methodName = "query14", where = "null", orderBy = "null", limit = "null"),
        @Query(methodName = "query15", where = "null", limit = "null"),
})
...
public class SampleDbModel implements Serializable {
    ...
    public SampleDbModel(String uniqueId, String name, String gender, String age, String score, String hobby) {
