...
public class ExpandListActivity extends Activity {
    ...
    private ExpandableListView test_expandablelistview;
    private MyAdapter adapter;
    private List<String> listParaent;
    private List<List<String>> listChild;
    private XCTitleLayout title;

    private TextView xc_id_search_slide_dialog;
    private OPSlideBar xc_id_search_slide_slidebar;
    ...
    public void initWidgets() {
        title = (XCTitleLayout) findViewById(R.id.xc_id_model_titlebar);
        test_expandablelistview = (ExpandableListView) findViewById(R.id.test_expandablelistview);
        xc_id_search_slide_dialog = (TextView) findViewById(R.id.xc_id_search_slide_dialog);
        xc_id_search_slide_slidebar = (OPSlideBar) findViewById(R.id.xc_id_search_slide_slidebar);
    ...
    public class MyAdapter extends XCBaseAdapterExpand<String, String> {
