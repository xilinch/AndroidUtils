...
import com.xiaocoder.android_ui.view.open.swipeadapter.OPSwipeLayoutAdapter;
...
public class SwipeAdapterActivity extends Activity {
    ...
    private OPSwipeLayoutAdapter mAdapter;
    ...
    //适配器
    class MyAdapater extends OPSwipeLayoutAdapter<String> {
