...
abstract public class XCRefreshLayout extends FrameLayout implements View.OnClickListener, View.OnTouchListener {
     ...
     * 刷新完成,需要外部调用
     */
    public void completeRefresh(boolean requestSuccess, boolean isShowZeroBg) {
    ...
    public void completeRefresh(boolean requestSuccess) {
        completeRefresh(requestSuccess, true);
    }
    ...
    public void resetCurrentPageAndList(XCBaseAdapter adapter) {
        resetCurrentPage();
        clearWhenPageOne();
        if (adapter != null) {
