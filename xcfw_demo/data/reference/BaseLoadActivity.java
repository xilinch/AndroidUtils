package com.xiaocoder.middle.base.function;
...
import com.xiaocoder.middle.base.BaseActivity;
import com.xiaocoder.middle.QLKSP;
...
public abstract class BaseLoadActivity extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (QLKSP.isFirstInstallApp()) {
            QLKSP.setFirstInstallApp(false);
            initWelCom();
        } else {
            initLoad();
        }
